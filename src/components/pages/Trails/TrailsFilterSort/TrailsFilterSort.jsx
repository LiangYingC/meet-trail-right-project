...
class TrailsFilterSort extends Component {
  ...
  render() {
    const { filterCheckedList, changeFilter, sortCheckedValue, changeSort } = this.props;

    const { isShowMobileFilterListSortBtn, isShowMobileFilterList, isShowMobileSortList } =
      this.state;
    ...
    return (
      <>
        ...
        />
        <div
          className={`mobile-show-filter-sort-btn ${isShowMobileFilterListSortBtn ? 'hide' : ''}`}
          onClick={this.showFilterSortBtn}
        >
        ...
        <div className={`mobile-filter-sort-btn ${isShowMobileFilterListSortBtn ? 'active' : ''}`}>
          <div className="show-filter-btn" onClick={this.toggleMobileFilterList}>
            <p>
              <i className="fas fa-filter"></i>篩選
            </p>
          </div>
          <div className="show-sort-btn" onClick={this.toggleMobileSortList}>
            <p>
              <i className="fas fa-sort-amount-up-alt"></i>排序
            </p>
          </div>
        </div>
      </>
